...
folder are mapped to the application's root namespace, 'CmsConfigExplorer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CmsConfigExplorer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CmsConfigExplorer' in the same way
as `"CmsConfigExplorer/sass/src"`.
