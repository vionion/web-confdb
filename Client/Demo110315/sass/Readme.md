...
folder are mapped to the application's root namespace, 'Demo110315'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Demo110315"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Demo110315' in the same way
as `"Demo110315/sass/src"`.
