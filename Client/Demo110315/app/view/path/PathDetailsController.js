Ext.define('Demo110315.view.path.PathDetailsController', {
...
//        this.getView().insert(2,desc); //("pathDetailsPanel")
    ...
    onPatDetLoaded: function( pid,  idc, idv){
        this.getViewModel().getStore('pathdetails').load({params: {pid: pid, cnf: idc, ver: idv}});
    }
