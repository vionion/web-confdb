Ext.define('Demo110315.view.endpath.EndPathDetailsController', {
...
//        this.getView().insert(2,desc); //("pathDetailsPanel")
    ...
    onEndPatDetLoaded: function( pid,  idc, idv){
        this.getViewModel().getStore('endpathdetails').load({params: {pid: pid, cnf: idc, ver: idv}});
    }
