...
Ext.define("CmsConfigExplorer.view.endpath.EndPathModuleDetails",{
    extend: "Ext.panel.Panel",
    
    requires:['CmsConfigExplorer.view.endpath.EndPathModuleDetailsModel',
             'CmsConfigExplorer.view.endpath.EndPathModuleDetailsController'],
