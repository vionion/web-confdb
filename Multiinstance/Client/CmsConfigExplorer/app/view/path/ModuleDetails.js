...
Ext.define("CmsConfigExplorer.view.path.ModuleDetails",{
    extend: "Ext.panel.Panel",

    requires:['CmsConfigExplorer.view.path.ModuleDetailsController',
             'CmsConfigExplorer.view.path.ModuleDetailsModel'],
