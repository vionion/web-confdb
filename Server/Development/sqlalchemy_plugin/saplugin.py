...
#    sa_engine_online = None
#    sa_engine_offline = None
    
    def __init__(self, bus, connection_string=None):
#    def __init__(self, bus, connection_string_online=None, connection_string_offline=None):
...
#        print "CONNECTION STRING 2: ", self.connection_string_offline
...
#        self.bus.subscribe("commit-session", self.commit)
        ...
        BaseCache.prepare(self.sa_engine_cache, reflect=True)
        
#        Base.prepare(self.sa_engine_online, reflect=True)
        
        print "BASE DONE AFAMMOCC"
