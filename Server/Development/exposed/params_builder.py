...
#        print not_in
        if (len(not_in) > 0):
            for n in not_in:
                if (n.lvl != 0):
                    if (n.id_parent in temp_vpset.viewkeys()):
                    ...
                    if (n.id_parent in temp_pset.viewkeys()):
...
#                    pset[s.id_parent].children.insert(s.order, s)
        ...
        #merge the psets created
        psKeys = pset.viewkeys() #pset.viewkeys()               
...
#            print item
            ...
            # It is a param
                ...
                print "ITem: ", item.lvl, " , ", item.order," , ", item.name
                if(item.lvl == 0):
                    temp_params.insert(item.order,item)
                    temp_params.sort(key=lambda par: par.order)
                else:
